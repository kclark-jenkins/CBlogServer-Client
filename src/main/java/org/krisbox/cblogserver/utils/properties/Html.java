...
public class Html implements Serializable
{
    ...
    private final static long serialVersionUID = 4148502493226959415L;
    ...
    public Html withStart(String start) {
        this.start = start;
        return this;
    }
    ...
    public Html withEnd(String end) {
        this.end = end;
        return this;
    }
    ...
    public Html withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
